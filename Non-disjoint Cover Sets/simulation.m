...
disp('MEAN OF MINIMUM COVERAGE : '); disp(RES_MIN_COV_RATE);
disp('MEAN OF MAXIMUM COVERAGE : '); disp(RES_MAX_COV_RATE);
disp('MEAN OF AVG COVERAGE : '); disp(RES_AVG_COV_RATE);
