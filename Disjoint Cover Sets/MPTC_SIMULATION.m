function [COLLECTION MIN_COVERAGE AVG_COVERAGE MAX_COVERAGE] = MPTC_SIMULATION(NB_NODES_F,NB_TARGETS_F,LENGTH_FIELD_F,SENSORS_MATRIX,TARGETS_MATRIX,ENERGY_INIT,ENERGY,RUNTIME)
